    ...
    <div className="space-y-2">
      ...
      <label
        ...
        className={`relative flex flex-col items-center justify-center border-2 border-dashed rounded-lg p-6 text-center space-y-4 transition-colors cursor-pointer 
          ...
          ${dragActive ? 'border-pink-400 bg-pink-50/5' : 'border-gray-600 hover:border-gray-500'}`}
      >
        <input
          id="file-upload"
          type="file"
        ...
        <div className="space-y-1">
          <p className="text-pink-400 font-medium">{selectedFile ? 'File Selected' : 'Click to upload'}</p>
